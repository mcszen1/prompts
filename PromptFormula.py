...
formato = st.selectbox('Escolha o Formato:', ['Esboço', 'Pontos Principais', 'Diálogo', 'Parágrafos', 'Plano de Aula', 'Argumentação de Prós e Contras', 'Lista de Palavras-Chave', '5 Sugestões de Título para YouTube'])
